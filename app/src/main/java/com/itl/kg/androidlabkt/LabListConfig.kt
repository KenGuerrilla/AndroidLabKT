...
val labList: List<LabItem> = mutableListOf(
    LabItem("CoroutineLab", "Coroutine Demo", MainFragmentDirections.actionMainFragmentToCoroutineLabFragment()) ,
    ...
    LabItem("NavigationLab", "Navigation測試範例", MainFragmentDirections.actionMainFragmentToNavigationLabActivity())
)
